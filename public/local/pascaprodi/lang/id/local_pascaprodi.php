...
$string['userrolepage'] = 'Daftarkan User, Role, dan Prodi';
$string['userrolepage_desc'] = 'Gunakan halaman ini untuk memilih user, memilih role akses dari database, dan memilih Prodi/kategori. Mahasiswa dimasukkan ke cohort Prodi. Dosen/globalteacher/Course creator/Manager diberi role pada kategori Prodi yang dipilih.';
