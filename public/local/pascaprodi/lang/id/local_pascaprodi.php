...
$string['adduserprodiheading_desc'] = 'Bagian ini wajib diisi saat tambah user baru. Pilih role akses dan Prodi/kategori. Mahasiswa dimasukkan ke cohort Prodi. Teacher/globalteacher/Course creator/Manager diberi role pada kategori Prodi yang dipilih.';
$string['field_user'] = 'User';
$string['field_accessrole'] = 'Role akses';
$string['field_accessrole_help'] = 'Wajib pilih role yang sudah ada di database Moodle. Role mahasiswa/student dipakai bersama cohort Prodi. Role dosen/globalteacher/Course creator/Manager akan diberikan pada kategori Prodi yang dipilih, sehingga bisa memilih beberapa Prodi.';
...
$string['field_categories_help'] = 'Wajib pilih kategori Program Studi. Untuk mahasiswa, pilih satu Prodi agar user dimasukkan ke cohort mahasiswa Prodi tersebut. Untuk dosen/globalteacher/Course creator/Manager, bisa pilih beberapa Prodi dan role akan diberikan pada kategori tersebut.';
