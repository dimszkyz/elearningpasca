...
$string['userrolepage'] = 'Assign User, Role, and Study Program';
$string['userrolepage_desc'] = 'Use this page to select a user, choose an access role from Moodle database, and choose Study Program categories. Students are added to the Study Program cohort. Teachers/globalteacher/Course creator/Manager roles are assigned at the selected Study Program category context.';
$string['field_user'] = 'User';
$string['field_accessrole'] = 'Access role';
$string['field_accessrole_help'] = 'Choose an existing Moodle role. Student roles work together with the Study Program cohort. Teacher/globalteacher/Course creator/Manager roles are assigned at the selected Study Program category, so they can be registered for multiple Study Programs.';
...
$string['field_categories_help'] = 'Choose Study Program categories. For students, choose one Study Program so the user is added to that student cohort. For teachers/globalteacher/Course creator/Manager, choose one or more Study Programs and the role will be assigned at those categories.';
